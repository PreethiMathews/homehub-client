...
function Search() {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.id === "sort_order") {
      const sort = e.target.value.split("_")[0] || "created_at"; //regularPrice for Price high to low n vice versa.. createdAt for lastest and oldest go we get criteria to be sorted on
    ...
    <div className="flex flex-col md:flex-row">
      <div className="p-7  border-b-2 md:border-r-2 md:min-h-screen">
        <form>
          ...
          <button className="bg-slate-700 text-white p-4 min-w-full rounded-lg uppercase hover:opacity-95 ">Search</button>
        </form>
      </div>
