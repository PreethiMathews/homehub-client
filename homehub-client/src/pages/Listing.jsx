...
function Listing() {
  ...
  console.log("list:", listing?.userRef);
        ...
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="flex gap-4">
              <p className="bg-blue-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">{listing.type === "rent" ? "For Rent" : "For Sale"}</p>
              <p className="bg-blue-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">${listing.regularPrice}</p>
            </div>
